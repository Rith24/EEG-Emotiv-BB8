...
avg_o1_abt_eyesOpen = 0.
avg_o1_abt_eyesClosed = 0.
avg_o2_abt_eyesOpen = 0.
avg_o2_abt_eyesClosed = 0.
...
def get_avg_abt_o1():
    global avg_o1_abt_eyesClosed
    global avg_o1_abt_eyesOpen
    return ((avg_o1_abt_eyesClosed + avg_o1_abt_eyesOpen) / 2)

# averaging o2_abt_eyesOpen and o2_abt_eyesClosed


def get_avg_abt_o2():
    global avg_o2_abt_eyesClosed
    global avg_o2_abt_eyesOpen
    return ((avg_o2_abt_eyesClosed + avg_o2_abt_eyesOpen) / 2)
...
def train(eyesopen):
    ...
    o1_abt_values_eyesOpen = []
    o1_abt_values_eyesClosed = []
    o2_abt_values_eyesClosed = []
    o2_abt_values_eyesOpen = []
        ...
        while packet_count < num_rec_packets:
            ...
            if packet is not None:
                ...
                if packet_count != 0 and packet_count % packet_chunk_size == 0:
                    ...
                    print("max O1: {} | max O2: {}".format(
                        max(o1_data), max(o2_data)))
                    ...
                    # Filtering
                    bp_low, bp_high = 1, 50
                    o1_data = butter_bandpass_filter(
                        o1_data, bp_low, bp_high, fs, order=5)
                    o2_data = butter_bandpass_filter(
                        o2_data, bp_low, bp_high, fs, order=5)
                    ...
                    if eyesopen:
                        ...
                        o1_ap = calc(o1_data, 10, 12, fs)
                        o1_tp = calc(o1_data, 4, 8, fs)
                        o1_abt_values_eyesOpen.append(o1_ap / o1_tp)
                        ...
                        o1_ap = calc(o1_data, 10, 12, fs)
                        o1_tp = calc(o1_data, 4, 8, fs)
                        o1_abt_values_eyesClosed.append(o1_ap / o1_tp)

                        o2_ap = calc(o2_data, 10, 12, fs)
                        o2_tp = calc(o2_data, 4, 8, fs)
                        o2_abt_values_eyesClosed.append(o2_ap / o2_tp)
    ...
    if eyesopen:
        avg_o1_abt_eyesOpen = sum(
            o1_abt_values_eyesOpen) / len(o1_abt_values_eyesOpen)
        avg_o2_abt_eyesOpen = sum(
            o2_abt_values_eyesOpen) / len(o2_abt_values_eyesOpen)
    else:
        avg_o1_abt_eyesClosed = sum(
            o1_abt_values_eyesClosed) / len(o1_abt_values_eyesClosed)
        avg_o2_abt_eyesClosed = sum(
            o2_abt_values_eyesClosed) / len(o2_abt_values_eyesClosed)


if __name__ == "__main__":
    # main_GUI.main()
    print
    print 'avg_o1_abt_eyesOpen', avg_o1_abt_eyesOpen
    print 'avg_o2_abt_eyesOpen', avg_o2_abt_eyesOpen
    print 'avg_o1_abt_eyesClosed', avg_o1_abt_eyesClosed
    print 'avg_o2_abt_eyesClosed', avg_o2_abt_eyesClosed
    print
